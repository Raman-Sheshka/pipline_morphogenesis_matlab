...
pathFolderRaw = 'C:\Users\ines\Documents\Python_Related\Evaluation_Stardist\wt_mov8\wt_mov8_starwat_v2.3.1';
filenameRaw = {'wt_mov8_DL_'};                  % can be multiple: {'pten_myo_' ; 'pten_baz_' ; ...}. NB: PIV will use FIRST listed
