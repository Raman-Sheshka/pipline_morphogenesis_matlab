...
pathFolderRaw = 'D:\Florencia\Analisys_Opto\Not_CARE\Pupe2\Analysis\NOTCARE_FloOpto_Pupe2_fused_all_part1';   
filenameRaw = {'NOTCARE_FloOpto_Pupe2_fused_all_part1_'};      
...
cloneName = 'Mask_fromFloROI_NOTCARE_FloOpto_Pupe2_fused_all_part1';                         % name to give to clone ("a-act", "fat"...)
cloneMaskFrame = [1];                    % frame number corresponding to clone mask
path2cloneMask = 'D:\Florencia\Analisys_Opto\Not_CARE\Pupe2\Analysis\NOTCARE_FloOpto_Pupe2_fused_all_part1\Clone_Mask\Mask_fromFloROI_NOTCARE_FloOpto_Pupe2_fused_all_part1.tif'; 
