...
pathFolderRaw = 'E:\_Analyses_in_progress\LaleNeck1';
filenameRaw = {'Projected__ECadGFP_DfdLifeActRuby_w2CSU-488_'};                  % can be multiple: {'pten_myo_' ; 'pten_baz_' ; ...}. NB: PIV will use FIRST listed
