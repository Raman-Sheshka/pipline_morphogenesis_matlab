...
finalFrame = 238;       % ends @ 182

%% Path to raw images %%

pathFolderRaw = 'D:\LabMeeting_10Fev\Images\Partie2\StarWat\LabMeetingStarWat\StarWatBin12Grid11\AzotKO2_StarWatBin12Grid11_Crop';
filenameRaw = {'AzotKO2_StarWatBin12Grid11_Crop_'};                  % can be multiple: {'pten_myo_' ; 'pten_baz_' ; ...}. NB: PIV will use FIRST listed
