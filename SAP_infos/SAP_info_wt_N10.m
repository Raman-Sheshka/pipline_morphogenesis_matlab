...
finalFrame = 246;       % ends @ 246

%% Path to raw images %%

pathFolderRaw = 'D:\MATLAB\Temporary\wt-N9-Macro_correction\wrt_N9_MC3';
filenameRaw = {'wt_N10_'};                  % can be multiple: {'pten_myo_' ; 'pten_baz_' ; ...}. NB: PIV will use FIRST listed
