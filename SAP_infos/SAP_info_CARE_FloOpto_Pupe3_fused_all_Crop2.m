...
startFrame = 3;         % starts @ 1        
finalFrame = 62;       % ends @ 62

%% Path to raw images %%

pathFolderRaw = 'D:\Florencia\Analisys_Opto\CARE\Pupe3\Cropped_Segmented_Pupe3_CARE\CARE_FloOpto_Pupe3_fused_all_Crop2';   
filenameRaw = {'CARE_FloOpto_Pupe3_fused_all_Crop2_'};      
...
frameRef = 3;                              % frame # corresponding to "timeRef" determined by "TimeRegistration"
timeRef = '17h45';                          % "timeRef" ('HH:MM' or decimal) corresponding to "frameRef" above
...
cloneName = 'Mask_fromFloROI_CARE_FloOpto_Pupe3_fused_all_Crop2';                         % name to give to clone ("a-act", "fat"...)
cloneMaskFrame = [3];                    % frame number corresponding to clone mask
path2cloneMask = 'D:\Florencia\Analisys_Opto\CARE\Pupe3\Cropped_Segmented_Pupe3_CARE\CARE_FloOpto_Pupe3_fused_all_Crop2\Clone_Mask\Mask_fromFloROI_CARE_FloOpto_Pupe3_fused_all_Crop2.tif'; 
