...
finalFrame = 291;       % ends @ 291

%% Path to raw images %%

pathFolderRaw = 'D:\Florencia\Analisys_Opto\CARE\Pupe2\Cropped_Segmented_Pupe2_CARE\CARE_FloOpto_Pupe2_fused_all';   
filenameRaw = {'CARE_FloOpto_Pupe2_fused_all_'};      
...
frameRef = 81;                              % frame # corresponding to "timeRef" determined by "TimeRegistration"
