...
finalFrame = 100;       % ends @ 100
%% Path to raw images %%

pathFolderRaw = 'D:\Aude\Movies_Analyses\EcRDN_b_Rotated';
filenameRaw = {'EcRDN_b_'};                  % can be multiple: {'pten_myo_' ; 'pten_baz_' ; ...}. NB: PIV will use FIRST listed
...
cloneName = 'CLONE_EcRDN_b';                         % name to give to clone ("a-act", "fat"...)
cloneMaskFrame = [50];                    % frame number corresponding to clone mask
path2cloneMask = 'D:\Aude\Movies_Analyses\EcRDN_b_Rotated\Clone_Mask\Mask_Rotated_Processed_EcRDN_b_CLONES_0050.tif'; 
