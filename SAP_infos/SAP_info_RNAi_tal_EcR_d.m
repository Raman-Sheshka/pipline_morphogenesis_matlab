...
finalFrame = 74;       % ends @ 74
%% Path to raw images %%

pathFolderRaw = 'D:\Aude\Movies_Analyses\RNAi_tal_EcR_d_Rotated';
filenameRaw = {'RNAi_tal_EcR_d_'};                  % can be multiple: {'pten_myo_' ; 'pten_baz_' ; ...}. NB: PIV will use FIRST listed
...
frameRef = 19;                              % frame # corresponding to "timeRef" determined by "TimeRegistration"
...
yMid = [966];                                 % y of midline IN PIXELS (leave empty [] if unknown)
...
cloneName = 'CLONE_RNAi_tal_EcR_d';                         % name to give to clone ("a-act", "fat"...)
cloneMaskFrame = [23];                    % frame number corresponding to clone mask
path2cloneMask = 'D:\Aude\Movies_Analyses\RNAi_tal_EcR_d_Rotated\Clone_Mask\Mask_Rotated_Processed_RNAi_tal_EcR_d_CLONES_0023.tif'; 
