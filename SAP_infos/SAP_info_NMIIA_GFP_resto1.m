...
finalFrame = 206;       % ends @ 206

%% Path to raw images %%

pathFolderRaw = 'E:\_Analyses_in_progress\BorisMovies\NMIIA_GFP_resto1';
filenameRaw = {'Restoredstackreg_2020-01-30_myosinIIA-GFP_ctrl_circ-abl_lapse5s_late_40x_03_'};                  % can be multiple: {'pten_myo_' ; 'pten_baz_' ; ...}. NB: PIV will use FIRST listed
...
halfNotum = 'l';                            % Chose between 'l' (left) 'r' (right) and 'b' 'both'
