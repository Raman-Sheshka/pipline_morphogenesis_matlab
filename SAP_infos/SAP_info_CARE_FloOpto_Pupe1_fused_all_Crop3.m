...
pathFolderRaw = 'D:\Florencia\Analisys_Opto\CARE\Pupe1\Cropped_Segmented_Pupe1_CARE\CARE_FloOpto_Pupe1_fused_all_Crop3';   
filenameRaw = {'CARE_FloOpto_Pupe1_fused_all_Crop3_'};      
...
timeRef = '13h24';                          % "timeRef" ('HH:MM' or decimal) corresponding to "frameRef" above
...
cloneName = 'Mask_fromFloROI_CARE_FloOpto_Pupe1_fused_all_Crop3';                         % name to give to clone ("a-act", "fat"...)
cloneMaskFrame = [1];                    % frame number corresponding to clone mask
path2cloneMask = 'D:\Florencia\Analisys_Opto\CARE\Pupe1\Cropped_Segmented_Pupe1_CARE\CARE_FloOpto_Pupe1_fused_all_Crop3\Clone_Mask\Mask_fromFloROI_CARE_FloOpto_Pupe1_fused_all_Crop3.tif'; 
