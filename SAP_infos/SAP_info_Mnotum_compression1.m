...
finalFrame = 280;       % ends @ 280
%% Path to raw images %%

pathFolderRaw = 'D:\Melanie\notum_compression_1';
filenameRaw = {'notum_compression_cad3xGFP_40x_bin1_+7_w2CSU-488_'};                  % can be multiple: {'pten_myo_' ; 'pten_baz_' ; ...}. NB: PIV will use FIRST listed
