...
pathFolderRaw = 'C:\Users\ines\Documents\Python_Related\Evaluation_Stardist\wt_mov12\wt_mov12_starwat_v2.3.1';
filenameRaw = {'wt_mov12_DL_'};                  % can be multiple: {'pten_myo_' ; 'pten_baz_' ; ...}. NB: PIV will use FIRST listed
...
frameRef = 52;                              % frame # corresponding to "timeRef" determined by "TimeRegistration"
