...
finalFrame = 77;       % ends @ 77
%% Path to raw images %%

pathFolderRaw = 'D:\Aude\Movies_Analyses\RNAi_tal_EcR_c_Rotated';
filenameRaw = {'RNAi_tal_EcR_c_'};                  % can be multiple: {'pten_myo_' ; 'pten_baz_' ; ...}. NB: PIV will use FIRST listed
...
yMid = [914];                                 % y of midline IN PIXELS (leave empty [] if unknown)
...
cloneName = 'CLONE_RNAi_tal_EcR_c';                         % name to give to clone ("a-act", "fat"...)
cloneMaskFrame = [30];                    % frame number corresponding to clone mask
path2cloneMask = 'D:\Aude\Movies_Analyses\RNAi_tal_EcR_c_Rotated\Clone_Mask\Mask_Rotated_Processed_RNAi_tal_EcR_c_CLONES_0030.tif'; 
