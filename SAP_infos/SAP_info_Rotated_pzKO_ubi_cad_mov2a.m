...
finalFrame = 207;       % ends @ 207

%% Path to raw images %%

pathFolderRaw = 'D:\Maria\pzKO2a_Rotated';
filenameRaw = {'Rotated_pzKO_ubi_cad_mov2a_'};                  % can be multiple: {'pten_myo_' ; 'pten_baz_' ; ...}. NB: PIV will use FIRST listed
