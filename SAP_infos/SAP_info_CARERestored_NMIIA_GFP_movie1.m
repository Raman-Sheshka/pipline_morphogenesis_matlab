...
pathFolderRaw = 'E:\_Analyses_in_progress\BorisMovies\NMIIA_GFP_movie1';
filenameRaw = {'CARERestored_NMIIA_GFP_movie1_'};                  % can be multiple: {'pten_myo_' ; 'pten_baz_' ; ...}. NB: PIV will use FIRST listed
