...
finalFrame = 205;       % ends @ 205

%% Path to raw images %%

pathFolderRaw = 'D:\Yohanns\wt3\wt3_DLsegBin12Grid11';
filenameRaw = {'wt3_'};                  % can be multiple: {'pten_myo_' ; 'pten_baz_' ; ...}. NB: PIV will use FIRST listed
