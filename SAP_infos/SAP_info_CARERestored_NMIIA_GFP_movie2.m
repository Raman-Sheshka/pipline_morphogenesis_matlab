...
pathFolderRaw = 'E:\_Analyses_in_progress\BorisMovies\NMIIA_GFP_movie2';
filenameRaw = {'CARERestored_NMIIA_GFP_movie2_'};                  % can be multiple: {'pten_myo_' ; 'pten_baz_' ; ...}. NB: PIV will use FIRST listed
