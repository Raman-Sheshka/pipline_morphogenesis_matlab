...
finalFrame = 238;       % ends @ 38

%% Path to raw images %%

pathFolderRaw = 'D:\LabMeeting_10Fev\Images\Partie2\StarWat\LabMeetingStarWat\StarWat\AzotKO2_StarWat_Crop';
filenameRaw = {'AzotKO2_StarWat_Crop_'};                  % can be multiple: {'pten_myo_' ; 'pten_baz_' ; ...}. NB: PIV will use FIRST listed
