...
finalFrame = 191;       % ends @ 191

%% Path to raw images %%

pathFolderRaw = 'D:\Floris\Movie_Analysis\ATR';
filenameRaw = {'Olga_Mei41_ECaddkihetero_29_MOV2_'};                  % can be multiple: {'pten_myo_' ; 'pten_baz_' ; ...}. NB: PIV will use FIRST listed
