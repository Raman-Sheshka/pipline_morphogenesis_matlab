...
pathFolderRaw = 'D:\Florencia\ZIP_Analysis\Segmentation\ZIPpupes_grouped\CPTs\ZIPpupes_grouped8_counterpart';   
filenameRaw = {'ZIPpupes_grouped8_counterpart_'};      
...
yMid = 468;                                 % y of midline IN PIXELS (leave empty [] if unknown)
...
path2cloneMask = 'D:\Florencia\ZIP_Analysis\Segmentation\ZIPpupes_grouped\CPTs\ZIPpupes_grouped8_counterpart\Mask_ZIPpupes_grouped\ZIPpupes_grouped_ZIPMask.tif'; 
