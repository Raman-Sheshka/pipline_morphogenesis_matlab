...
finalFrame = 146;       % ends @ 146

%% Path to raw images %%

pathFolderRaw = 'D:\Florencia\Analisys_Opto\CARE\Pupe2\Cropped_Segmented_Pupe2_CARE\CARE_FloOpto_Pupe2_fused_all_Crop2';   
filenameRaw = {'CARE_FloOpto_Pupe2_fused_all_Crop2_'};      
...
timeRef = '10h30';                          % "timeRef" ('HH:MM' or decimal) corresponding to "frameRef" above
...
yMid = 808;                                 % y of midline IN PIXELS (leave empty [] if unknown)
...
cloneName = 'Mask_fromFloROI_CARE_FloOpto_Pupe2_fused_all_Crop2';                         % name to give to clone ("a-act", "fat"...)
cloneMaskFrame = [1];                    % frame number corresponding to clone mask
path2cloneMask = 'D:\Florencia\Analisys_Opto\CARE\Pupe2\Cropped_Segmented_Pupe2_CARE\CARE_FloOpto_Pupe2_fused_all_Crop2\Clone_Mask\Mask_fromFloROI_CARE_FloOpto_Pupe2_fused_all_Crop2.tif'; 
