...
finalFrame = 20;       % ends @ 20

%% Path to raw images %%

pathFolderRaw = 'D:\Florencia\Analisys_Opto\Not_CARE\Pupe3\Analysis\NOTCARE_FloOpto_Pupe3_fused_all_part1';   
filenameRaw = {'NOTCARE_FloOpto_Pupe3_fused_all_part1_'};      
...
yMid = 362;                                 % y of midline IN PIXELS (leave empty [] if unknown)
...
cloneName = 'Mask_fromFloROI_NOTCARE_FloOpto_Pupe3_fused_all_part1.tif';                         % name to give to clone ("a-act", "fat"...)
cloneMaskFrame = [1];                    % frame number corresponding to clone mask
path2cloneMask = 'D:\Florencia\Analisys_Opto\Not_CARE\Pupe3\Analysis\NOTCARE_FloOpto_Pupe3_fused_all_part1\Clone_Mask\Mask_fromFloROI_NOTCARE_FloOpto_Pupe3_fused_all_part1.tif'; 
