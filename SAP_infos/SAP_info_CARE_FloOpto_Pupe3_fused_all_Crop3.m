...
finalFrame = 130;       % ends @ 130

%% Path to raw images %%

pathFolderRaw = 'D:\Florencia\Analisys_Opto\CARE\Pupe3\Cropped_Segmented_Pupe3_CARE\CARE_FloOpto_Pupe3_fused_all_Crop3';   
filenameRaw = {'CARE_FloOpto_Pupe3_fused_all_Crop3_'};      
...
timeRef = '12h10';                          % "timeRef" ('HH:MM' or decimal) corresponding to "frameRef" above
...
cloneName = 'Mask_fromFloROI_CARE_FloOpto_Pupe3_fused_all_Crop3';                         % name to give to clone ("a-act", "fat"...)
cloneMaskFrame = [3];                    % frame number corresponding to clone mask
path2cloneMask = 'D:\Florencia\Analisys_Opto\CARE\Pupe3\Cropped_Segmented_Pupe3_CARE\CARE_FloOpto_Pupe3_fused_all_Crop3\Clone_Mask\Mask_fromFloROI_CARE_FloOpto_Pupe3_fused_all_Crop3.tif'; 
