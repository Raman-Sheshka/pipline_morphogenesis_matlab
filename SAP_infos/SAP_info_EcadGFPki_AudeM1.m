...
finalFrame = 105;       % ends @ 105
%% Path to raw images %%

pathFolderRaw = 'D:\Aude\Movies_Analyses\EcadGFPki_AudeM1_rotated';
filenameRaw = {'EcadGFPki_AudeM1_'};                  % can be multiple: {'pten_myo_' ; 'pten_baz_' ; ...}. NB: PIV will use FIRST listed
...
dt = 10;                                     % time IN MINUTES between two frames
temperature = 29;                           % temperature (25 or 29C) at which development was filmed
yMid = [816];                                 % y of midline IN PIXELS (leave empty [] if unknown)
...
cloneName = 'CLONE_AUDEM1';                         % name to give to clone ("a-act", "fat"...)
cloneMaskFrame = [49];                    % frame number corresponding to clone mask
path2cloneMask = 'D:\Aude\Movies_Analyses\EcadGFPki_AudeM1_rotated\Clone_Mask\Clone_Mask_EcadGFPki_AudeM1_0049.tif'; 
% 
%% Scale Bar & Display %%
