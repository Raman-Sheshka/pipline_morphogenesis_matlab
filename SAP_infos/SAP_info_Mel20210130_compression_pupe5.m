...
finalFrame = 287;       % ends @ 287
%% Path to raw images %%

pathFolderRaw = 'E:\_Analyses_in_progress\Melanie\AnalysesDivisions\20210130_compression_pupe5';
filenameRaw = {'Projected_notum_compression_cad3xGFP_40x_bin1_+7_w2CSU-488_'};                  % can be multiple: {'pten_myo_' ; 'pten_baz_' ; ...}. NB: PIV will use FIRST listed
...
timeRef = '15h00';                          % "timeRef" ('HH:MM' or decimal) corresponding to "frameRef" above
