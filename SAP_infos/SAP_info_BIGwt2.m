...
pathFolderRaw = 'D:\BigMovies\BIGwt2';
% pathFolderRaw = 'D:\BigMovies\BIGwt2NoSeg';
filenameRaw = {'BIGwt2_'};                  % can be multiple: {'pten_myo_' ; 'pten_baz_' ; ...}. NB: PIV will use FIRST listed
...
frameRef = 95;                              % frame # corresponding to "timeRef" determined by "TimeRegistration"
...
yMid = 1127;    % 1131 from ML clicks       % y of midline IN PIXELS (leave empty [] if unknown)
...
boxSize = [80 80] ./ [xFactor yFactor];  	% grid compartment size IN PIXELS [WIDTH HEIGHT]. One value => square grid
...
% xMacro1 = 321;                                       % 1st macro X coord clicked @26 hAPF
