...
pathFolderRaw = 'E:\_Analyses_in_progress\BorisMovies\LifeAct_GFP_movie1';
filenameRaw = {'CARERestored_LifeAct_GFP_movie1_'};                  % can be multiple: {'pten_myo_' ; 'pten_baz_' ; ...}. NB: PIV will use FIRST listed
