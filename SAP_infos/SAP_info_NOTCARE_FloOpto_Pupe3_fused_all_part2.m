...
pathFolderRaw = 'D:\Florencia\Analisys_Opto\Not_CARE\Pupe3\Analysis\NOTCARE_FloOpto_Pupe3_fused_all_part2';   
filenameRaw = {'NOTCARE_FloOpto_Pupe3_fused_all_part2_'};      
...
cloneName = 'Mask_fromFloROI_NOTCARE_FloOpto_Pupe3_fused_all_part2.tif';                         % name to give to clone ("a-act", "fat"...)
cloneMaskFrame = [21];                    % frame number corresponding to clone mask
path2cloneMask = 'D:\Florencia\Analisys_Opto\Not_CARE\Pupe3\Analysis\NOTCARE_FloOpto_Pupe3_fused_all_part2\Clone_Mask\Mask_fromFloROI_NOTCARE_FloOpto_Pupe3_fused_all_part2.tif'; 
