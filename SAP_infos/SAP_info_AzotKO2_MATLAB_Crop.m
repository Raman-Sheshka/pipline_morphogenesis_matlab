...
pathFolderRaw = 'D:\LabMeeting_10Fev\Images\Partie2\StarWat\LabMeetingStarWat\MATLAB\AzotKO2_MATLAB_Crop';
filenameRaw = {'AzotKO2_MATLAB_Crop_'};                  % can be multiple: {'pten_myo_' ; 'pten_baz_' ; ...}. NB: PIV will use FIRST listed
