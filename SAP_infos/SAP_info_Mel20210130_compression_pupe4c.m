...
pathFolderRaw = 'E:\_Analyses_in_progress\Melanie\AnalysesCompressions\Mel20210130_compression_pupe4c';
filenameRaw = {'Mel20210130_compression_pupe4c_'};                  % can be multiple: {'pten_myo_' ; 'pten_baz_' ; ...}. NB: PIV will use FIRST listed
