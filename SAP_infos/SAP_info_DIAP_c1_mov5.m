...
finalFrame = 133;       % ends @ 133
%% Path to raw images %%

pathFolderRaw = 'D:\Maria\DIAP_c1_mov5';
filenameRaw = {'DIAP_c1_mov5_'};                  % can be multiple: {'pten_myo_' ; 'pten_baz_' ; ...}. NB: PIV will use FIRST listed
...
frameRef = 29;                              % frame # corresponding to "timeRef" determined by "TimeRegistration"
...
cloneName = 'DIAP1';                         % name to give to clone ("a-act", "fat"...)
cloneMaskFrame = [1];                    % frame number corresponding to clone mask
path2cloneMask = 'D:\Maria\DIAP_c1_mov5\Masks_DIAP_clone_mov5\Mask_DIAP_clone_mov5_0001.tif'; 
