...
pathFolderRaw = 'D:\Florencia\ZIP_Analysis\Segmentation\ZIPpupes_grouped\CPTs\ZIPpupes_grouped3_counterpart';   
filenameRaw = {'ZIPpupes_grouped3_counterpart_'};      
...
yMid = 560;                                 % y of midline IN PIXELS (leave empty [] if unknown)
...
path2cloneMask = 'D:\Florencia\ZIP_Analysis\Segmentation\ZIPpupes_grouped\CPTs\ZIPpupes_grouped3_counterpart\Mask_ZIPpupes_grouped\ZIPpupes_grouped_ZIPMask.tif'; 
...
imageResolution = 500;                  % 300 used for formalism article, 200 for Potts CppTD images, between 300 and 150 for CppTD images
