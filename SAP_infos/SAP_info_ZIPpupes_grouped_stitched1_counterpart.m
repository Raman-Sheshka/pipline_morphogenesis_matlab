...
pathFolderRaw = 'D:\Florencia\ZIP_Analysis\Segmentation\ZIPpupes_grouped_stitched\CPTs\ZIPpupes_grouped_stitched1_counterpart';   
filenameRaw = {'ZIPpupes_grouped_stitched1_counterpart_'};      
...
yMid = 457;                                 % y of midline IN PIXELS (leave empty [] if unknown)
...
cloneName = 'ZIPpupes_grouped_stitched_ZIPMask';                         % name to give to clone ("a-act", "fat"...)
cloneMaskFrame = [1];                    % frame number corresponding to clone mask
path2cloneMask = 'D:\Florencia\ZIP_Analysis\Segmentation\ZIPpupes_grouped_stitched\CPTs\ZIPpupes_grouped_stitched1_counterpart\Mask_ZIPpupes_grouped_stitched\ZIPpupes_grouped_stitched_ZIPMask.tif'; 
