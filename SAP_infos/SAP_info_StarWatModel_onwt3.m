...
finalFrame = 205;       % ends @ 245
%% Path to raw images %%

pathFolderRaw = 'C:\Users\ines\Documents\Wild_Types\TestModels\StarWatModel_onwt3';
filenameRaw = {'StarWatModel_onwt3_'};                  % can be multiple: {'pten_myo_' ; 'pten_baz_' ; ...}. NB: PIV will use FIRST listed
