...
startFrame = 55;         % starts @ 55        
finalFrame = 278;       % ends @ 278 

%% Path to raw images %%

pathFolderRaw = 'D:\Florencia\Analisys_Opto\Not_CARE\Pupe2\Analysis\NOTCARE_FloOpto_Pupe2_fused_all_part3';   
filenameRaw = {'NOTCARE_FloOpto_Pupe2_fused_all_part3_'};      
...
timeRef = '22h03';                          % "timeRef" ('HH:MM' or decimal) corresponding to "frameRef" above
...
cloneName = 'Mask_fromFloROI_NOTCARE_FloOpto_Pupe2_fused_all_part3';                         % name to give to clone ("a-act", "fat"...)
cloneMaskFrame = [55];                    % frame number corresponding to clone mask
path2cloneMask = 'D:\Florencia\Analisys_Opto\Not_CARE\Pupe2\Analysis\NOTCARE_FloOpto_Pupe2_fused_all_part3\Clone_Mask\Mask_fromFloROI_NOTCARE_FloOpto_Pupe2_fused_all_part3.tif'; 
