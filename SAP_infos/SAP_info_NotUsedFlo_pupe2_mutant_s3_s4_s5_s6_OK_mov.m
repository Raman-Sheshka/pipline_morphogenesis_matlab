...
finalFrame = 194;       % ends @ 194

%% Path to raw images %%

pathFolderRaw = 'D:\Florencia\Analysis_Florencia_Big_RhoGEF4\pupe2_mutant_s3_s4_s5_s6_OK_mov';
filenameRaw = {'Flo_pupe2_mutant_s3_s4_s5_s6_OK_mov_'};                  % can be multiple: {'pten_myo_' ; 'pten_baz_' ; ...}. NB: PIV will use FIRST listed
...
frameRef = 47;                              % frame # corresponding to "timeRef" determined by "TimeRegistration"
timeRef = '24h30';                          % "timeRef" ('HH f:MM' or decimal) corresponding to "frameRef" above
