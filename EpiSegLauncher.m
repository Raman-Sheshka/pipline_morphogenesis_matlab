...
% LAUNCH FROM MATLAB FOLDER

%animal = 'Flo_pupe1_s1_s2_s3_s4_mov';      % Animal generic name to process, reference to an AIA_info file
                      % NB: Please keep those name simple, e.i. wt1, trbl4, ...
                         
                         

animal = 'CARERestored_NMIIA_GFP_movie1';   
...
%segZone = [414 352 803 647];   % segmentation zone (rectangular, in [x y w h])
segZone = [];   % segmentation zone (rectangular, in [x y w h])
...
runAutoCorrection = 0;
nbCorrectionRound = 4; % advice number of round 1 to 6 
