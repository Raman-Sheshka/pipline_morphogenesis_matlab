...
avgAnimalsWhiteRNAis= {'wt_mov8_DLcorr' ;   'wt_N10_DLcorr'  ;  'wt_mov11_DLcorr' ; 'wt_mov12_DLcorr' ; 'wt_mov13_DLcorr'};
avgAnimalsPdm3s = { 'pdm3_01';'pdm3_02';'pdm3_03';'pdm3_04';'pdm3_05'};
% avgAnimalsWhite = {'White2' ; 'White7'};
% avgAnimalsWTs= {'wt29c1' ; 'wt29c3'};
avgAnimalsPotts = {'S07'};
avgAnimalsFloSmall = {'Flo_pupe2_s5_s6_mov';'RhoGEF4_movie28_2_19_mov'};
avgAnimalsFloBig = {'Flo_pupe1_s1_s2_s3_s4_mov';'Flo_pupe1_sym_s1_s2_s3_s4_mov';'Flo_pupe2_mutant_s5_s6_s7_s8_mov';'Flo_pupe2_sym_mutant_s5_s6_s7_s8_mov';'Flo_pupe3_s7_s8_s9_s10_mov';'Flo_pupe3_sym_s7_s8_s9_s10_mov';'Flo_pupe4_sym_mutant_s13_s14_s15_s16_mov'};
%--------------------------------------------------------------------------
...
% parentRescaledAnimalsFolder = 'C:\Users\ines\Documents\Python_Related\Evaluation_Stardist\BIGs';
% rescaleName = 'BIG_'; 
% PathName = 'C:\Users\ines\Documents\Python_Related\Evaluation_Stardist\Rescaled_BIG';                             % Global output path: all outputs will be saved there in a structure file.
...
% parentRescaledAnimalsFolder = 'C:\Users\ines\Documents\Python_Related\Evaluation_Stardist';
% rescaleName = 'whiteRNAis_';
% PathName = 'C:\Users\ines\Documents\Python_Related\Evaluation_Stardist';                     % Global output path: all outputs will be saved there in a structure file.
...
% rescaleName = 'mfX_';
% 
% mapAnimal = 'FloBig';                                               % name of average animal OR actual animal name (BIG1, TRBL4...) when processing single animal
% avgAnimals = avgAnimalsFloBig;
% parentRescaledAnimalsFolder = 'E:\_Analyses_in_progress\Florencia\Analysis_Florencia_Big_RhoGEF4\FloBig\';
% rescaleName = 'FloBig_'; 
% PathName = 'E:\_Analyses_in_progress\Florencia\Analysis_Florencia_Big_RhoGEF4\FloBig\';                             % Global output path: all outputs will be saved there in a structure file.


mapAnimal = 'whiteRNAis';                                               % name of average animal OR actual animal name (BIG1, TRBL4...) when processing single animal
avgAnimals = avgAnimalsWhiteRNAis;
parentRescaledAnimalsFolder = 'E:\_Analyses_in_progress\Florencia\Analysis_Florencia_Big_RhoGEF4\Archetype_white';
rescaleName = 'whiteRNAis_'; 
PathName = 'E:\_Analyses_in_progress\Florencia\Analysis_Florencia_Big_RhoGEF4\Archetype_white';      
...
%%% Archetype related:
parentArchetypeFolder = 'E:\_Analyses_in_progress\Florencia\Archetype_white';            % PARENT folder that will contain archetypes made at different clicking times
archetypeName = 'whiteRNAi_';                                          % prefix that will appear before "archetype_..." in folder name
...
% Qname = {'UPIV'};
% Qname = {'U','UPIV'};
% Qname = {'EG';'ED';'ER';'ES';'EA';'Epsilon';'rPatchArea';'rCellArea';'U';'Omega';'EF';'EN'};
...
% deltaAnimals  = { 'BIGs' ; 'whiteRNAis'};
% deltaAnimals  = { 'whiteRNAis' ; 'BIGs'};
% deltaAnimals  = { 'meanWT_grid26h' ; 'meanWT_grid26h'};
deltaAnimals  = { 'FloBig' ; 'whiteRNAis'};
