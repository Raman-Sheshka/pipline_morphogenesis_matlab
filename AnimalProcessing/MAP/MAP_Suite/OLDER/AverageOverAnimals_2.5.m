            ...
            if isfield(AOA_backup,Qname{j}) % 2.3
                ...
                if PLOT.print
                    ...
                    if strcmp(imageExtension,'.svg')
                        plot2svg([OutputPathName filesep 'Frames_AOA_' QplotType filesep thisFilename],figure(1),'png');
                    else
                        print(printFormat, printResolution, [OutputPathName filesep 'Frames_AOA_' QplotType filesep thisFilename]);
                    end
                end
                close
