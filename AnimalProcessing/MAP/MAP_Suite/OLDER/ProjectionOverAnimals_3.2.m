...
GridInfo = {'xywh' ; 'size' ; 'Lcentroids' ; 'overlap' ; 'color' ; 'centroids' ; 'ULCs' ; 'lineWidth' ; 'TimeArray' ; 'FrameArray' ;...
            ...
            'sizeImageX' ; 'sizeImageY'; 'yMid'}; % added in 3.2
...
thisFilename = [outputPath filesep 'POA_' uAnimal '_' tagProjectionTime fullTag '.mat']; % added fullTag (3.2)
...
if PLOT.plot
    ...
    BACKUP = load([outputPath filesep 'POA_' uAnimal '_' tagProjectionTime  fullTag]); % added fullTag (3.2)
    Lt = size(BACKUP.FrameArray,1);
    
    %%% plot parameters (mod 3.2)
    DISPLAY.yMid = BACKUP.yMid;             % 3.2
