...
if ~isempty(Qname) && PLOT.plot
    ...
    DISPLAY.Animal = DOAname; % indicates the difference of means in plot (1.6)
    ...
    for t = 1:Lt
        ...
        for j=1:length(Qname)
            ...
            if PLOT.print
                ...
                thisFilename = ['DOA_' Qname{j} '_' timeStart 'to' timeEnd fullTag KillTrTag '_sr=' num2str(Qsr(1)) printFormat]; % 1.6
%                 thisFilename = ['DOA_' DOAname '_' Qname{j} '_' timeStart 'to' timeEnd fullTag KillTrTag '_sr=' num2str(Qsr(1)) printFormat]; % 1.5
    ...
    DISPLAY.Animal = Animal; % reverts DOAname to Animal (1.6)
end
