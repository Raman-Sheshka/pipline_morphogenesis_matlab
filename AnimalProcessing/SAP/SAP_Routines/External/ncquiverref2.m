function ncquiverref2(x,y,u,v,units,reftype,refvec,veccol,cont)

% 2010/02/10:
% Modified by Isabelle Bonnet
% Arrows are thiner 
% Vectors width are thicker (épais)
% Legend is displayed at the left top corner instead of the bottom one.
% (manage with ij axis, useful for my experimental movies)
...
%
% $Id: ncquiverref.m 412 2009-01-18 11:06:01Z aroberts $
...
if col 
 ...
 for i=1:length(cont)
  ...
  % Plot the vectors
  line(lx,ly,'Color',hc(i,:),'LineWidth',1);
 ...
 % Plot the vectors
 line(lx,ly,'Color',veccol,'LineWidth',1);
...
if refvec
 ...
 ylim=get(gca,'ylim'); yp1=2*ylim(1); yp2=ylim(2);
 ...
 ht=text(xstart,yend,2.1,reftext,'Parent',gca,'FontSize',8.5,...
         'VerticalAlignment','Middle','HorizontalAlignment','Right');
 ...
 line(lx,ly,lz,'Color',veccol,'LineWidth',1);
